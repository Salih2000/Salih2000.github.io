...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/tr-tur/";
          ...
          section: "Navigasyon menüsü",
          handler: () => {
            window.location.href = "/tr-tur/teaching/";
          },
        },{id: "nav-people",
          title: "people",
          ...
          section: "Navigasyon menüsü",
          handler: () => {
            window.location.href = "/tr-tur/people/";
          },
    ...
    },
    {
      ...
      description: 'Sitenin temasını Karanlık olarak değiştir',
      section: 'Tema',
      handler: () => {
    ...
    },
    {
      ...
      description: 'Sitenin temasını Sistem Varsayılanı olarak değiştir',
      section: 'Tema',
      handler: () => {
